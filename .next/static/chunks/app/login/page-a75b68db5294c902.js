(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2626],{3045:function(e,t,r){Promise.resolve().then(r.bind(r,76))},76:function(e,t,r){"use strict";r.r(t),r.d(t,{default:function(){return h}});var a=r(7437),s=r(2265),n=r(6463),i=r(8726);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let l=(0,r(8030).Z)("EyeOff",[["path",{d:"M9.88 9.88a3 3 0 1 0 4.24 4.24",key:"1jxqfv"}],["path",{d:"M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68",key:"9wicm4"}],["path",{d:"M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61",key:"1jreej"}],["line",{x1:"2",x2:"22",y1:"2",y2:"22",key:"a6p6uj"}]]);var c=r(5733),o=r(4453),u=r(6198);function d(){(0,n.useRouter)();let e=(0,n.useSearchParams)().get("redirect")||"/dashboard",[t,r]=(0,s.useState)({email:"",password:""}),[u,d]=(0,s.useState)(!1),[h,m]=(0,s.useState)(!1);async function x(r){r.preventDefault(),m(!0);try{let r=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),a=await r.json();if(!r.ok){i.ZP.error(a.error||"بيانات خاطئة");return}i.ZP.success("مرحباً بك!"),window.location.href=e}catch(e){i.ZP.error("خطأ في الاتصال")}finally{m(!1)}}return(0,a.jsxs)("form",{onSubmit:x,className:"space-y-5",children:[(0,a.jsxs)("div",{children:[(0,a.jsx)("label",{className:"label",children:"البريد الإلكتروني"}),(0,a.jsx)("input",{type:"email",required:!0,className:"input text-center",placeholder:"admin@mokhtar-school.ma",value:t.email,onChange:e=>r(t=>({...t,email:e.target.value}))})]}),(0,a.jsxs)("div",{children:[(0,a.jsx)("label",{className:"label",children:"كلمة المرور"}),(0,a.jsxs)("div",{className:"relative",children:[(0,a.jsx)("input",{type:u?"text":"password",required:!0,className:"input text-center pl-10",placeholder:"••••••••",value:t.password,onChange:e=>r(t=>({...t,password:e.target.value}))}),(0,a.jsx)("button",{type:"button",onClick:()=>d(!u),className:"absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600",children:u?(0,a.jsx)(l,{size:18}):(0,a.jsx)(c.Z,{size:18})})]})]}),(0,a.jsxs)("button",{type:"submit",disabled:h,className:"w-full bg-primary hover:bg-primary-light text-white font-black py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-60",children:[(0,a.jsx)(o.Z,{size:18}),h?"جاري الدخول...":"دخول"]})]})}function h(){return(0,a.jsx)("div",{className:"min-h-screen bg-gradient-to-br from-primary via-primary-light to-secondary flex items-center justify-center p-4",children:(0,a.jsxs)("div",{className:"w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8",children:[(0,a.jsxs)("div",{className:"text-center mb-8",children:[(0,a.jsx)("div",{className:"w-20 h-20 bg-primary rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg",children:(0,a.jsx)(u.Z,{size:36,className:"text-white"})}),(0,a.jsx)("h1",{className:"text-2xl font-black text-primary dark:text-white",children:"لوحة تحكم الإدارة"}),(0,a.jsx)("p",{className:"text-gray-500 dark:text-gray-400 text-sm mt-1",children:"مجموعة مدارس محمد المخطار"})]}),(0,a.jsx)(s.Suspense,{fallback:(0,a.jsx)("div",{className:"text-center py-4 text-gray-400",children:"جاري التحميل..."}),children:(0,a.jsx)(d,{})}),(0,a.jsxs)("p",{className:"text-center text-xs text-gray-400 mt-6",children:["للتجربة: ",(0,a.jsx)("span",{className:"font-bold text-primary",children:"admin@mokhtar-school.ma"})," / ",(0,a.jsx)("span",{className:"font-bold text-primary",children:"admin123"})]})]})})}},8030:function(e,t,r){"use strict";r.d(t,{Z:function(){return c}});var a=r(2265);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
